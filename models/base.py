...
class UserWechat(TimestampMixin):
    ...
    user_phone = fields.CharField(unique=True, null=True, max_length=15, description='手机号')
...
class User(TimestampMixin):
    role: fields.ManyToManyRelation["Role"] = \
        fields.ManyToManyField("base.Role", null=True, related_name="user", on_delete=fields.SET_NULL)
    username = fields.CharField(null=True, max_length=50, description="用户名")
    ...
    rest_minute = fields.IntField(default=0, description='剩余分钟数')
    wechat: fields.OneToOneRelation[UserWechat]
    charge_group_list = fields.ReverseRelation['Group']
...
class Role(TimestampMixin):
    ...
    access: fields.ManyToManyRelation["Access"] = \
        fields.ManyToManyField("base.Access", null=True, related_name="role", on_delete=fields.SET_NULL)
